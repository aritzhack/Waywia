...
public class BDSCompound extends BDS {
	...
	public void writeToStream(OutputStream s) {
		try {
			s.write(this.getBytes());
		} catch (IOException e) {
			GameLogger.logAndThrowAsRuntime("Could not write BDSCompound to OutputStream " + s, e);
		}
	}
	...
	String toString(int level) {
		...
		builder.append(Util.repeatString("    ", level))
